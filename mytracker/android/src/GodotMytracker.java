...
public class GodotMytracker extends Godot.SingletonBase {

    private Godot activity = null;

    static public Godot.SingletonBase initialize(Activity p_activity) 
    { 
        return new GodotMytracker(p_activity); 
    } 

    public GodotMytracker(Activity p_activity) 
    {
        registerClass("GodotMytracker", new String[]{
                "init",
                "event",
                "event_with_param",
                "event_with_params",
